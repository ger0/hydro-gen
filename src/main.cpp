...
constexpr auto particle_file                    = "particle.glsl";
constexpr auto erosion_particle_file            = "particle_erosion.glsl";
...
int main(int argc, char* argv[]) { 
    ...
    */
    ...
    comput_part.bind_uniform_block("map_settings", map_settings.buffer);
